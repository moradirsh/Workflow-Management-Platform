...
def create_case(db: Session, title: str, description: str | None = None, assignee_id: int | None = None, priority: str | None = None, file_content: str | None = None, file_path: str | None = None, file_name: str | None = None, org_id: int | None = None, created_by: int | None = None, group_id: int | None = None, custom_role_id: int | None = None):
    case = Case(title = title, description = description, assignee_id = assignee_id, priority = priority, file_path = file_path, file_name = file_name, org_id = org_id, created_by = created_by, group_id = group_id, custom_role_id = custom_role_id)
    db.add(case)
    db.commit()
    db.refresh(case)
